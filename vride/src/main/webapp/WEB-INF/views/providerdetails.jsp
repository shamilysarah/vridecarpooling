...
function showalert()
{
	alert("Inserted Cab Details Successfully!");
}
          ...
          <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt=""/>
            ...
            <form:form id="prodet" modelAttribute="provider" action="detailProcess" method="post">
                ...
                <table align="center">
                    ...
                    <tr>
                        <td></td>
                        <td><a href="/" style="color:white;">Home</a>
                        </td>
                    </tr>
                   <tr><td></td><td></td></tr>
                     <tr>
                        <td></td>
                      <td>  <a href="riderlist" style="color:black;display:inline;">Click here to see booked list</a>
                        </td>                      
                    </tr>
                     <tr><td></td><td></td></tr>
                     <tr>
                     <td></td>
                     <td> <a href="editordelete"style="color:white;">Click here to edit or detele</a></td>
                     </tr>
